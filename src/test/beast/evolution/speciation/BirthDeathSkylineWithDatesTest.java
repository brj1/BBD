...
import beast.evolution.speciation.BirthDeathSkylineWithDatesModel;
...
/**
 * @author Denise Kuehnert and Bradley R. Jones
 */
@Description("Test the BirthDeathSerialSkylineModelWithDates with a small tree example")

public class BirthDeathSkylineWithDatesTest extends TestCase {
    ...
    public void testmultiRho2tipsNoDeath() throws Exception {
        ...
        BirthDeathSkylineWithDatesModel bdm = new BirthDeathSkylineWithDatesModel();
...
//        assertEquals(-13.738804989064041, bdm.calculateLogP(), 1e-4);   // this result is from BEAST, not double checked in R
    ...
    @Test
    public void testmultiRhoWithDates() throws Exception {

        Tree tree = new TreeParser("((3[&type=0]: 1.5, 4[&type=0]: 1.5)[&type=0]: 1 , (1[&type=0]: 2, 2[&type=0]: 2)[&type=0]: 3)[&type=0];", false);

        TraitSet dates = new TraitSet();
        dates.initByName("traitname", "date", "taxa", tree.getTaxonset(), "value", "1=5,2=5,3=2.5,4=2.5");
        dates.initAndValidate();
        tree.setDateTrait(dates);
        ...
        bdm.setInputValue("samplingProportion", new RealParameter("0."));
        bdm.setInputValue("rho", new RealParameter("1. 1."));
        bdm.setInputValue("rhoSamplingDates", new RealParameter("5. 2.5"));
        bdm.setInputValue("reverseTimeArrays", "false false false true");
        bdm.setInputValue("conditionOnSurvival", false);
        bdm.setInputValue("origin", "10.");
        ...
        bdm.setInputValue("rho", new RealParameter("0.5 1."));
        bdm.initAndValidate();
        double d = bdm.calculateLogP();
        assertEquals(-19.29773458054159, d, 1e-4);   // this result is from BEAST, not double checked in R
//
        bdm.setInputValue("rho", new RealParameter("0.01 0.01"));
        bdm.initAndValidate();
        assertEquals(-14.676660714677519, bdm.calculateLogP(), 1e-4);   // this result is from BEAST, not double checked in R
...
//        bdm.setInputValue("origin", "1e-100");
    ...
    public void testYule() throws Exception {
        ...
        BirthDeathSkylineWithDatesModel bdssm = new BirthDeathSkylineWithDatesModel();
    ...
    public void testRhoSasha() throws Exception {
        ...
        bdssm = new BirthDeathSkylineWithDatesModel();
        bdssm.setInputValue("tree", tree);
        bdssm.setInputValue("origin", new RealParameter("2."));
        bdssm.setInputValue("conditionOnSurvival", false);
    ...
    @Test
    public void testRhoSashaWithDates() throws Exception {
        ...
        //root date 2000
        TraitSet dates = new TraitSet();
        dates.initByName("traitname", "date", "taxa", tree.getTaxonset(), "value",
                "t1=2001,"
                + "t25=2001,"
                + "t23=2001,"
                + "t16=2000.5448020938,"
                ...
                + "t10=2001,"
                + "t15=2001,"
                + "t19=2000.90275645465,"
                + "t6=2000.37507158458,"
                + "t11=2000.45328666628,"
                + "t3=2001,"
                + "t24=2001,"
                + "t13=2001,"
                + "t8=2001,"
        ...
        bdssm.setInputValue("samplingRate", new RealParameter("2."));
        bdssm.setInputValue("rho", new RealParameter("0.0 0.05 0.01"));
        bdssm.setInputValue("rhoSamplingDates", "2001. 2000. 1999.5");
        bdssm.setInputValue("reverseTimeArrays", "false false false false");
        bdssm.initAndValidate();
        ...
        bdssm.setInputValue("samplingRate", new RealParameter("2."));
        bdssm.setInputValue("rho", new RealParameter("0.0 0.05 0.01"));
        bdssm.setInputValue("rhoSamplingDates", "2001. 2000.5 2000");
        bdssm.setInputValue("reverseTimeArrays", "false false false true");
        bdssm.initAndValidate();
        assertEquals(-124.96086690757612, bdssm.calculateTreeLogLikelihood(tree), 1e-4);     // this result is from BEAST, not double checked in R
...
//         bdssm.setInputValue("intervalTimes", new RealParameter("0. 3. 4.5"));
    ...
    public void testDateChange() throws Exception {
        ...
        Tree tree = new TreeParser("((3[&type=0]: 1.5, (5[&type=0]: 0.5, 4[&type=0]: 1): 0.5)[&type=0]: 1, (1[&type=0]: 2, 2[&type=0]: 2)[&type=0]: 3)[&type=0];", false);

        TraitSet dates = new TraitSet();
        dates.initByName("traitname", "date", "taxa", tree.getTaxonset(), "value", "1=5,2=5,3=2.5,4=2.5,5=2");
        dates.initAndValidate();
        tree.setDateTrait(dates);
        ...
        bdm.setInputValue("conditionOnSurvival", false);
        bdm.setInputValue("origin", "10.");
        bdm.setInputValue("samplingProportion", new RealParameter("0.01"));
        ...
        // Init test
        assertEquals(-21.93528, bdm.calculateTreeLogLikelihood(tree), 1e-4);
        
        // Find node to change height
        int i = 0;
        for (String taxaName: tree.getTaxaNames()) {
            if (taxaName.equals("5")) {                
                break;
            }
        ...
        Double oriHeight = node.getHeight();

        node.setHeight(oriHeight + 0.25);
        assertEquals(-21.91085, bdm.calculateTreeLogLikelihood(tree), 1e-4);
    }
